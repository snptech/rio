                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="net_wt" id="net_wt"
                                    value="{{ isset($edit_ganerat_lable->net_wt) ? $edit_ganerat_lable->net_wt : old("net_wt") }}"
                                    placeholder="">
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tare_wt"
                                    value="{{ isset($edit_ganerat_lable->tare_wt) ? $edit_ganerat_lable->tare_wt : old("tare_wt") }}"
                                    id="tare_wt" placeholder="">
                            </div>
                        </div>
                    </div>
