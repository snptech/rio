    ...
    <div style="display:block;padding:20px;border:2px solid #000;min-height:15.4in;">
		<table width="100%" cellpadding="10" cellspacing="0" border="0">
			<tr>
				...
				<td style="text-align:center;"><h2 style="font-family: serif;font-size: 2rem;">RioCare India Private Limited</h2><p style="font-family: serif;font-size:1rem;font-weight:bold;">Plot R-940, TTC Industrial Area, MIDC Rabale, Navi Mumbai &ndash; 400 701, Maharashtra, INDIA.</p></td>
				<td width="80">&nbsp;</td>
			</tr>
		</table>
