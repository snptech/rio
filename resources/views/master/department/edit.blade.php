            ...
            <form class="login100-form validate-form" action="{{ route('department-update',["id"=>$department->id]) }}" method="POST" id="departmentForm">
                ...
                <div class="form-row">
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="department" id="department" placeholder="Department Name" value="{{ old("department")?old("department"):$department->department }}">
                ...
                <div class="form-row">
                    <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                        <div class="form-group">
                            <label for="from">Department Type</label>
                            <div>
