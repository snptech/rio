                ...
                <div class="form-row">
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="manufacturer" id="manufacturer" placeholder="Manufacturer" value="{{ old("manufacturer")?old("manufacturer"):$manufacturer->manufacturer }}">
