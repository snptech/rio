<div class="container-scroller">
    ...
    <div style="display:block;padding:20px;border:1px solid #000;min-height:11.7in;">
		...
		<div style="padding:1rem 0;text-align:center;text-decoration:underline;font-size:1.4rem;font-weight:bold;color:#313131;">PRODUCT LABEL</div>
