												...
												<td>
													<table width="auto" cellpadding="5" cellspacing="0" border="0" style="font-size:1.1rem;font-weight:bold;font-family: serif;margin:0 1.2rem 0rem;line-height:1.1;text-align:left !important;">
														...
														<tr>
															<td>MFG DATE</td>
															<td>:</td>
															<td>{{$lables->mfg_date}}</td>
														</tr>
														<tr>
															<td>RETEST DATE</td>
															<td>:</td>
															<td>{{$lables->retest_date}}</td>
														</tr>
													</table>
												</td>
												<td>
													<table width="auto" cellpadding="5" cellspacing="0" border="0" style="font-size:1.1rem;font-weight:bold;font-family: serif;margin:0 1.2rem 0rem;line-height:1.1;text-align:left !important;">
														...
														<tr>
															<td>NET WT</td>
															<td>:</td>
															<td>{{$lables->net_wt_200}}</td>
														</tr>
														<tr>
															<td>TARE WT</td>
															<td>:</td>
															<td>{{$lables->tare_wt_200}}</td>
														</tr>
													</table>
												</td>
											</tr>
												...
												<td>
													<table width="auto" cellpadding="5" cellspacing="0" border="0" style="font-size:1.1rem;font-weight:bold;font-family: serif;margin:0 1.2rem 0rem;line-height:1.1;text-align:left !important;">
														...
														<tr>
															<td>NET WT</td>
															<td>:</td>
															<td>{{$lables->net_wt_50}}</td>
														</tr>
														<tr>
															<td>TARE WT</td>
															<td>:</td>
															<td>{{$lables->tare_wt_50}}</td>
														</tr>
													</table>
												</td>
											</tr>
												...
												<td>
													<table width="auto" cellpadding="5" cellspacing="0" border="0" style="font-size:1.1rem;font-weight:bold;font-family: serif;margin:0 1.2rem 0rem;line-height:1.1;text-align:left !important;">
														...
														<tr>
															<td>NET WT</td>
															<td>:</td>
															<td>{{$lables->net_wt_30}}</td>
														</tr>
														<tr>
															<td>TARE WT</td>
															<td>:</td>
															<td>{{$lables->tare_wt_30}}</td>
														</tr>
													</table>
												</td>
											</tr>
			...
			<!-- Main Container -->
				<div style="display:block;padding:20px;border:2px solid #000;min-height:11.7in;">
						...
						@if(isset($manufacture) && $manufacture)
							...
							@if(isset($lables) && $lables)
									<div style="padding:1rem 0;text-align:center;text-decoration:underline;font-size:1.4rem;font-weight:bold;color:#313131;">PRODUCT LABEL 5 kg Drums</div>
									<div style="padding:2rem;text-align:center;margin:1.5rem;border:2px solid #000;">
										<div style="padding:0rem 0 1rem;text-align:center;font-size:1.1rem;font-weight:bold;color:#313131;">{{strtoupper($manufacture->material_name)}}   -100%</div>
										<div style="padding:1rem 0;text-align:center;font-size:1.1rem;font-weight:bold;color:#313131;">FILIX -110</div>
										<table width="100%" cellpadding="10" cellspacing="0" border="0" class="heading-tbl">
												...
												<td>
													<table width="auto" cellpadding="5" cellspacing="0" border="0" style="font-size:1.1rem;font-weight:bold;font-family: serif;margin:0 1.2rem 0rem;line-height:1.1;text-align:left !important;">
														...
														<tr>
															<td>NET WT</td>
															<td>:</td>
															<td>{{$lables->net_wt_5}}</td>
														</tr>
														<tr>
															<td>TARE WT</td>
															<td>:</td>
															<td>{{$lables->tare_wt_5}}</td>
														</tr>
													</table>
												</td>
											</tr>
