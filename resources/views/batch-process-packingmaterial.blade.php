<div class="container-scroller">
    ...
    <div style="display:block;padding:20px;border:2px solid #000;min-height:11.7in;">
		...
		@if(isset($manufacture) && $manufacture)
            ...
            <div style="padding:1rem 0;text-align:left;text-decoration:underline;font-size:0.8rem;font-weight:bold;color:#616161;">Requestion Bill of Packaging Material Details</div>
