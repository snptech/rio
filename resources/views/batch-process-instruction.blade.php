<div class="container-scroller">
    ...
    <div style="display:block;padding:20px;border:1px solid #000;min-height:11.7in;">
		...
		@if(isset($manufacture) && $manufacture)
			...
			<div style="padding:2rem 0;text-align:center;text-decoration:underline;font-size:1.4rem;font-weight:bold;color:#000;margin-bottom:2rem">General Instrction for Manufacturing.</div>
