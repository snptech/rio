        ...
        <div class="card main-card">
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li><a data-toggle="tab" class="{{ $sequenceId == '12' ? 'active' : '' }}"
                            area-selected="{{ $sequenceId == '12' ? 'true' : 'false' }}" href="#Packing">Packing</a></li>
                    <li><a data-toggle="tab" class="{{ $sequenceId == '13' ? 'active' : '' }}"
                            area-selected="{{ $sequenceId == '13' ? 'true' : 'false' }}" href="#generate_label">Generate
                            Label</a></li>
                </ul>
            ...
            $(add_button).click(function(e) { //on add input button click
                ...
                if (x < max_fields) { //max input box allowed
                    ...
                    $(wrapper).append(
                        ...
                        x +
                        ']"><option>Select</option><option>Material Name</option></select></div></div><div class="col-12 col-md-6 col-lg-4"><div class="form-group"><label for="Quantity[' +
                        x +
