    ...
    <div style="display:block;padding:20px;border:1px solid #000;min-height:11.7in;">
		...
		<table class="table table-bordered">
			<thead>
				...
				<tr>
					<td>Once the temperature is between 100 - 120oC start the Inline mixer and charge ColloidalSilicon Dioxide (Fumed Silica) in reactor simultaneously and increase stirring speed.</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
